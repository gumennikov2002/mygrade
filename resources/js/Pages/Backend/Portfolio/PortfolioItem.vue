<template>
    ...
    <DefaultLayout>
        ...
        <div v-if="form.recentlySuccessful" class="d-flex align-items-center alert alert-success bg-brand-pink">
            <i class="lni lni-thumbs-up bg-light text-brand-pink p-1 rounded-5"></i>
            <span class="px-2">Портфолио сохранено</span>
        </div>
...
import { Breadcrumb, Portfolio } from "../../../Types/types";
import Breadcrumbs from "../../../Components/Backend/Page/Breadcrumbs.vue";
...
const form = useForm<Portfolio>(props.portfolio ?? {
    id: null,
    slug: '',
    isActive: true,
    title: '',
...
const breadcrumbs = ref<Breadcrumb[]>([
    ...
    { title: form.id ?  'Редактирование портфолио' : 'Создание портфолио', url: null }
]);
